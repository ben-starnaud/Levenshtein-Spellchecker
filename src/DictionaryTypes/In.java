...
/*************************************************************************
 *  Compilation:  javac DictionaryTypes.In.java
 *  Execution:    java DictionaryTypes.In   (basic test --- see source for required files)
 *
...
public class In {
    ...
    /*** begin: section (1 of 2) of code duplicated from DictionaryTypes.In to DictionaryTypes.StdIn */
    ...
    /*** end: section (1 of 2) of code duplicated from DictionaryTypes.In to DictionaryTypes.StdIn */
   ...
   /**
    ...
    /*** begin: section (2 of 2) of code duplicated from DictionaryTypes.In to DictionaryTypes.StdIn,
   ...
   /**
    ...
    public char readChar() {
        ...
        assert (ch.length() == 1) : "Internal (Std)DictionaryTypes.In.readChar() error!"
   ...
   /**
    ...
    /*** end: section (2 of 2) of code duplicated from DictionaryTypes.In to DictionaryTypes.StdIn */
   ...
   /**
     ...
     * <tt>new DictionaryTypes.In(filename)</tt>.{@link #readAllInts()}
     */
   ...
   /**
     ...
     * @deprecated Clearer to use 
     * <tt>new DictionaryTypes.In(filename)</tt>.{@link #readAllDoubles()}
     */
   ...
   /**
     ...
     * @deprecated Clearer to use 
     * <tt>new DictionaryTypes.In(filename)</tt>.{@link #readAllStrings()}
     */
