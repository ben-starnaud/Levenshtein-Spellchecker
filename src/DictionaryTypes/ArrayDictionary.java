...
/**
 * ArrayDictionary Class that uses array to form a Dictionary - this class inherits from the ArrayTypeDictionary class
 * and uses the interface of the DictionaryInterface class.
 */
public class ArrayDictionary extends ArrayTypeDictionary implements DictionaryInterface {
    ...
    /**
     * Creates dictionary to store the words in an Array Data Structure
     * <p>
    ...
    /**
     * isWord returns a boolean value to say if the word provided is in the Data Structure
     * <p>
    ...
    /**
     * addNewWord adds a new word to the Array Data Structure
     * <p>
    ...
    /**
     * removeWord removes a word from the Array Data Structure
     * <p>
    ...
    /**
     * getDictionaryWords is a ArrayList<String> that puts all the words from the Data Structure
